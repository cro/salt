# -*- coding: utf-8 -*-
'''
Utilities for Junos native minions
'''
...
def __virtual__():
    ...
    '''
    if not HAS_JUNOS:
        return False, 'Missing dependency: The junos proxy minion requires \'jnpr\', \'jsnapy\', and \'ncclient\' modules'
